...
export const days: Day[] = [
	{
		title: 'Ça continue !',
		text: "Nous y sommes, nous commençons enfin à poser les murs et l'accomplissement commence à se percevoir. Dans la joie, la bonne humeur et l'humour, on porte, on visse et on rigole. Sastisfaits de n'avoir que quelques légers imprévus, nous profitons d'un chantier agréable malgré un vent prononcé qui n'a pas encore posé de problème. Merci à vous qui suivez ce chantier et merci à ce projet qui nous fait vivre de beaux moments humains.",
		image: 'https://s5.imgcdn.dev/BafeD.jpg'
	},
	{
		title: 'Deuxième jour de labeur',
		text: "Au bout du deuxième jour, les murs sont presque élevés et même une partie du plafond a commencé à surgir. Tout le monde a toujours ses deux mains et 10 doigts ! L'équipe de 16 à 81 ans collaborent bien dans la bonne humeur. Demain, le dernier mur et le plafond nous attendent. L'ajout d'une porte a bien occupé Théo et son apprenti Antoine. Nous construisons un chalet mais aussi des connaissances chez les jeunes générations. La météo est de notre côté avec un soleil radieux qui appelle la crème solaire.",
		image: 'https://s5.imgcdn.dev/Ba8cM.jpg'
	},
	{
...
export const gallery = [
	...
	{ url: 'https://s5.imgcdn.dev/BabD2.jpg', title: 'Équilibristes' },
	{ url: 'https://s5.imgcdn.dev/Badzy.jpg' },
	{ url: 'https://s5.imgcdn.dev/BaWM9.jpg' },
	{ url: 'https://s5.imgcdn.dev/BafeD.jpg' },

	{ url: 'https://s5.imgcdn.dev/BaHQC.jpg' },
	{ url: 'https://s5.imgcdn.dev/BaqgS.jpg' },
	{ url: 'https://s5.imgcdn.dev/Bage0.jpg', title: 'Main à la patte' },
	{ url: 'https://s5.imgcdn.dev/BaXGe.jpg' },
	{ url: 'https://s5.imgcdn.dev/Ba8cM.jpg' },

	{ url: 'https://s5.imgcdn.dev/Baotl.jpg' },
